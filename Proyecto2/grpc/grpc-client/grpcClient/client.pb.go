...
type RequestId struct {
	...
	Carnet   uint64 `protobuf:"varint,1,opt,name=carnet,proto3" json:"carnet,omitempty"`
	...
	Nota     uint32 `protobuf:"varint,4,opt,name=nota,proto3" json:"nota,omitempty"`
...
func (x *RequestId) GetCarnet() uint64 {
	if x != nil {
		return x.Carnet
	}
	return 0
...
func (x *RequestId) GetNota() uint32 {
	if x != nil {
		return x.Nota
	}
	return 0
...
func (x *RequestId) GetYear() uint32 {
	if x != nil {
		return x.Year
	}
	return 0
...
var file_client_proto_rawDesc = []byte{
	...
	0x74, 0x18, 0x01, 0x20, 0x01, 0x28, 0x04, 0x52, 0x06, 0x63, 0x61, 0x72, 0x6e, 0x65, 0x74, 0x12,
	...
	0x04, 0x6e, 0x6f, 0x74, 0x61, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x04, 0x6e, 0x6f, 0x74,
